...
// export let followActionCreator = 
export let follow = 
...
export let setCurrentPage = 
  (pageNumber) => ({ type: SET_PAGE, pageNumber,});
export let setTotalUserCount= 
  (count) => ({type: SET_TOTAL_USER_COUNT, totalCount: count })
export let setIsFetching = 
